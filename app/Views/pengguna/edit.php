...
<div class="container-fluid" x-data="ui">
    <!--begin::Form-->
    <form @submit.prevent='handleSubmit' class="form" method="POST" action="<?= site_url() ?>pengguna/edit/<?= $pengguna['id'] ?>" id="addForm">
        <?= csrf_field() ?>
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="nama" class="form-control form-control-lg form-control-solid" placeholder="" value="<?= old('nama', (isset($pengguna['nama'])) ? $pengguna['nama'] : '') ?>" />
                    ...
                    <div class="row mb-6" x-data="{show:true}" @click="show=false">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="email" class="form-control form-control-lg form-control-solid" placeholder="" value="<?= old('email', (isset($pengguna['username'])) ? $pengguna['username'] : '') ?>" />
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="role" aria-label="Select a Country" data-control="select2" data-placeholder="Pilih Role" class="form-select form-select-solid form-select-lg fw-semibold">
                                ...
                                <?php foreach ($roles as $role) : ?>
                                    <option value="<?= $role['id'] ?>" <?= (old('role', (isset($pengguna['role'])) ? $pengguna['role'] : '') == $role['id']) ? 'selected' : ''; ?>><?= $role['role'] ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="active" aria-label="Select a Country" data-control="select2" data-placeholder="Pilih Propinsi" class="form-select form-select-solid form-select-lg fw-semibold">
                                <option value="1" <?= ($pengguna['active'] == 1) ? 'selected' : ''; ?>>Aktif</option>
                                <option value="0" <?= ($pengguna['active'] != 1) ? 'selected' : ''; ?>>Tidak Aktif</option>
                            </select>
                            <span class="text-danger"><?= $validation->getError('active') ?></span>
                        </div>
                        <!--end::Col-->
                        <!--end::Col-->
                    </div>
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="angkatan" aria-label="Select a prodi" data-control="select2" data-placeholder="Pilih Angkatan" class="form-select form-select-solid form-select-lg fw-semibold">
                                ...
                                <?php foreach ($angkatan as $ak) : ?>
                                    <option value="<?= $ak['tahun'] ?>" <?= (old('angkatan', (isset($pengguna['angkatan'])) ? $pengguna['angkatan'] : '') == $ak['tahun']) ? 'selected' : '' ?>><?= $ak['tahun'] ?></option>
                                <?php endforeach; ?>
                            </select>
            ...
            <div class="collapse show">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="password" name="password" class="form-control form-control-lg form-control-solid" placeholder="" value="<?= old('password') ?>" />
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="password" name="password2" class="form-control form-control-lg form-control-solid" placeholder="" value="<?= old('password2') ?>" />
