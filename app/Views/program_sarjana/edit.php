                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="twisuda" aria-label="Pilih tahun wisdua" data-control="select2" data-placeholder="Pilih Tahun Wisuda" class="form-select form-select-solid form-select-lg fw-semibold">
                                ...
                                <?php foreach ($filteredAngkatan as $ak) : ?>
                                    <option value="<?= $ak['tahun'] ?>" <?= (old('twisuda', (isset($wisuda['twisuda'])) ? $wisuda['twisuda'] : '') == $ak['tahun']) ? 'selected' : '' ?>><?= $ak['tahun'] ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="blnwisuda" aria-label="Pilih Bulan Wisuda" data-control="select2" data-placeholder="Pilih Bulan Wisuda" class="form-select form-select-solid form-select-lg fw-semibold">
                                  <option value="">Pilih Bulan Wisuda</option>
                                <?php foreach ($bulan as $bl) : ?>
                                    <option value="<?= $bl['id'] ?>" <?= (old('blnwisuda', (isset($wisuda['blnwisuda'])) ? $wisuda['blnwisuda'] : '') == $bl['id']) ? 'selected' : '' ?>><?= $bl['nama'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <!--end::Col-->
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="notice  rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="row mb-6" x-data="{show:false}">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input x-show="!show" @click="show=true" type="text" name="s1_prodi" class="form-control form-control-lg form-control-solid" placeholder="" value="<?= old('s1_prodi', (isset($S1['prodi'])) ? $S1['prodi'] : '') ?>" />
                            <span x-show="!show" class="text-danger"><?= $validation->getError('s1_prodi') ?></span>
